...
$flash_map = @(
    ...
    @{ Offset = "0x530000"; File = "stella_app.bin";       Desc = "Stella (ota_4)" },
    @{ Offset = "0x6B0000"; File = "prosystem_app.bin";    Desc = "ProSystem (ota_5)" },
    @{ Offset = "0x790000"; File = "handy_app.bin";        Desc = "Handy (ota_6)" },
