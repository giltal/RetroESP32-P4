/*
 * SDL_scancode.h compat header for Duke3D PSRAM app.
 * Copied from the original Duke3D ESP32 port with no changes.
 */
...
typedef enum {
    ...
    SDL_SCANCODE_STOP = 120, SDL_SCANCODE_AGAIN = 121,
    SDL_SCANCODE_UNDO = 122, SDL_SCANCODE_CUT = 123,
    SDL_SCANCODE_COPY = 124, SDL_SCANCODE_PASTE = 125,
    SDL_SCANCODE_FIND = 126, SDL_SCANCODE_MUTE = 127,
    ...
    SDL_SCANCODE_KP_A = 188, SDL_SCANCODE_KP_B = 189,
    SDL_SCANCODE_KP_C = 190, SDL_SCANCODE_KP_D = 191,
    ...
    SDL_SCANCODE_EJECT = 281, SDL_SCANCODE_SLEEP = 282,
