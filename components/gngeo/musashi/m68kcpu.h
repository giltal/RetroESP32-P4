...
static const uint32 m68ki_shift_32_table[65] =
{
...
INLINE uint32 m68ki_read_imm_16(void);
INLINE uint32 m68ki_read_imm_32(void);

/* Read from the current address space */
INLINE uint32 m68ki_read_8(uint32 address);
INLINE uint32 m68ki_read_16(uint32 address);
INLINE uint32 m68ki_read_32(uint32 address);

/* Write to the current data space */
INLINE void m68ki_write_8(uint32 address, uint32 value);
INLINE void m68ki_write_16(uint32 address, uint32 value);
INLINE void m68ki_write_32(uint32 address, uint32 value);

/* Indexed and PC-relative ea fetching */
INLINE uint32 m68ki_get_ea_pcdi(void);
INLINE uint32 m68ki_get_ea_pcix(void);
INLINE uint32 m68ki_get_ea_ix(uint32 An);

/* Operand fetching */
INLINE uint32 OPER_AY_AI_8(void);
INLINE uint32 OPER_AY_AI_16(void);
INLINE uint32 OPER_AY_AI_32(void);
INLINE uint32 OPER_AY_PI_8(void);
INLINE uint32 OPER_AY_PI_16(void);
INLINE uint32 OPER_AY_PI_32(void);
INLINE uint32 OPER_AY_PD_8(void);
INLINE uint32 OPER_AY_PD_16(void);
INLINE uint32 OPER_AY_PD_32(void);
INLINE uint32 OPER_AY_DI_8(void);
INLINE uint32 OPER_AY_DI_16(void);
INLINE uint32 OPER_AY_DI_32(void);
INLINE uint32 OPER_AY_IX_8(void);
INLINE uint32 OPER_AY_IX_16(void);
INLINE uint32 OPER_AY_IX_32(void);

INLINE uint32 OPER_AX_AI_8(void);
INLINE uint32 OPER_AX_AI_16(void);
INLINE uint32 OPER_AX_AI_32(void);
INLINE uint32 OPER_AX_PI_8(void);
INLINE uint32 OPER_AX_PI_16(void);
INLINE uint32 OPER_AX_PI_32(void);
INLINE uint32 OPER_AX_PD_8(void);
INLINE uint32 OPER_AX_PD_16(void);
INLINE uint32 OPER_AX_PD_32(void);
INLINE uint32 OPER_AX_DI_8(void);
INLINE uint32 OPER_AX_DI_16(void);
INLINE uint32 OPER_AX_DI_32(void);
INLINE uint32 OPER_AX_IX_8(void);
INLINE uint32 OPER_AX_IX_16(void);
INLINE uint32 OPER_AX_IX_32(void);

INLINE uint32 OPER_A7_PI_8(void);
INLINE uint32 OPER_A7_PD_8(void);

INLINE uint32 OPER_AW_8(void);
INLINE uint32 OPER_AW_16(void);
INLINE uint32 OPER_AW_32(void);
INLINE uint32 OPER_AL_8(void);
INLINE uint32 OPER_AL_16(void);
INLINE uint32 OPER_AL_32(void);
INLINE uint32 OPER_PCDI_8(void);
INLINE uint32 OPER_PCDI_16(void);
INLINE uint32 OPER_PCDI_32(void);
INLINE uint32 OPER_PCIX_8(void);
INLINE uint32 OPER_PCIX_16(void);
INLINE uint32 OPER_PCIX_32(void);

/* Stack operations */
INLINE void m68ki_push_16(uint32 value);
INLINE void m68ki_push_32(uint32 value);
INLINE uint32 m68ki_pull_16(void);
INLINE uint32 m68ki_pull_32(void);

/* Program flow operations */
INLINE void m68ki_jump(uint32 new_pc);
INLINE void m68ki_jump_vector(uint32 vector);
INLINE void m68ki_branch_8(uint32 offset);
INLINE void m68ki_branch_16(uint32 offset);
INLINE void m68ki_branch_32(uint32 offset);

/* Status register operations. */
INLINE void m68ki_set_s_flag(uint32 value);            /* Only bit 2 of value should be set (i.e. 4 or 0) */
INLINE void m68ki_set_ccr(uint32 value);               /* set the condition code register */
INLINE void m68ki_set_sr(uint32 value);                /* set the status register */

/* Exception processing */
INLINE uint32 m68ki_init_exception(void);              /* Initial exception processing */
INLINE void m68ki_stack_frame_3word(uint32 pc, uint32 sr); /* Stack various frame types */
#if M68K_EMULATE_ADDRESS_ERROR
INLINE void m68ki_stack_frame_buserr(uint32 sr);
#endif
INLINE void m68ki_exception_trap(uint32 vector);
INLINE void m68ki_exception_trapN(uint32 vector);
#if M68K_EMULATE_TRACE
...
#endif
INLINE void m68ki_exception_interrupt(uint32 int_level);
...
INLINE uint32 m68ki_read_8(uint32 address)
{
  uint32 addr = ADDRESS_68K(address);
  uint32 region = (addr >> 20) & 0xF;

  if (region == 0x0) return FETCH8ROM(addr);
  if (region == 0x1) return FETCH8RAM(addr);
  if (region == 0x2) return FETCH8BANK(addr);
  if (region == 0xC) return FETCH8BIOS(addr);
...
INLINE uint32 m68ki_read_16(uint32 address)
{
  ...
  if (region == 0x0) return FETCH16ROM(addr);
  if (region == 0x1) return FETCH16RAM(addr);
  if (region == 0x2) return FETCH16BANK(addr);
  if (region == 0xC) return FETCH16BIOS(addr);
...
INLINE uint32 m68ki_read_32(uint32 address)
{
  ...
  if (region == 0x0) return FETCH32ROM(addr);
  if (region == 0x1) return FETCH32RAM(addr);
  if (region == 0x2) return FETCH32BANK(addr);
  if (region == 0xC) return FETCH32BIOS(addr);
...
{
  /* An = base register */
  uint32 extension = m68ki_read_imm_16();
...
/* Fetch operands */
INLINE uint32 OPER_AY_AI_8(void)  {uint32 ea = EA_AY_AI_8();  return m68ki_read_8(ea); }
INLINE uint32 OPER_AY_AI_16(void) {uint32 ea = EA_AY_AI_16(); return m68ki_read_16(ea);}
INLINE uint32 OPER_AY_AI_32(void) {uint32 ea = EA_AY_AI_32(); return m68ki_read_32(ea);}
INLINE uint32 OPER_AY_PI_8(void)  {uint32 ea = EA_AY_PI_8();  return m68ki_read_8(ea); }
INLINE uint32 OPER_AY_PI_16(void) {uint32 ea = EA_AY_PI_16(); return m68ki_read_16(ea);}
INLINE uint32 OPER_AY_PI_32(void) {uint32 ea = EA_AY_PI_32(); return m68ki_read_32(ea);}
INLINE uint32 OPER_AY_PD_8(void)  {uint32 ea = EA_AY_PD_8();  return m68ki_read_8(ea); }
INLINE uint32 OPER_AY_PD_16(void) {uint32 ea = EA_AY_PD_16(); return m68ki_read_16(ea);}
INLINE uint32 OPER_AY_PD_32(void) {uint32 ea = EA_AY_PD_32(); return m68ki_read_32(ea);}
INLINE uint32 OPER_AY_DI_8(void)  {uint32 ea = EA_AY_DI_8();  return m68ki_read_8(ea); }
INLINE uint32 OPER_AY_DI_16(void) {uint32 ea = EA_AY_DI_16(); return m68ki_read_16(ea);}
INLINE uint32 OPER_AY_DI_32(void) {uint32 ea = EA_AY_DI_32(); return m68ki_read_32(ea);}
INLINE uint32 OPER_AY_IX_8(void)  {uint32 ea = EA_AY_IX_8();  return m68ki_read_8(ea); }
INLINE uint32 OPER_AY_IX_16(void) {uint32 ea = EA_AY_IX_16(); return m68ki_read_16(ea);}
INLINE uint32 OPER_AY_IX_32(void) {uint32 ea = EA_AY_IX_32(); return m68ki_read_32(ea);}

INLINE uint32 OPER_AX_AI_8(void)  {uint32 ea = EA_AX_AI_8();  return m68ki_read_8(ea); }
INLINE uint32 OPER_AX_AI_16(void) {uint32 ea = EA_AX_AI_16(); return m68ki_read_16(ea);}
INLINE uint32 OPER_AX_AI_32(void) {uint32 ea = EA_AX_AI_32(); return m68ki_read_32(ea);}
INLINE uint32 OPER_AX_PI_8(void)  {uint32 ea = EA_AX_PI_8();  return m68ki_read_8(ea); }
INLINE uint32 OPER_AX_PI_16(void) {uint32 ea = EA_AX_PI_16(); return m68ki_read_16(ea);}
INLINE uint32 OPER_AX_PI_32(void) {uint32 ea = EA_AX_PI_32(); return m68ki_read_32(ea);}
INLINE uint32 OPER_AX_PD_8(void)  {uint32 ea = EA_AX_PD_8();  return m68ki_read_8(ea); }
INLINE uint32 OPER_AX_PD_16(void) {uint32 ea = EA_AX_PD_16(); return m68ki_read_16(ea);}
INLINE uint32 OPER_AX_PD_32(void) {uint32 ea = EA_AX_PD_32(); return m68ki_read_32(ea);}
INLINE uint32 OPER_AX_DI_8(void)  {uint32 ea = EA_AX_DI_8();  return m68ki_read_8(ea); }
INLINE uint32 OPER_AX_DI_16(void) {uint32 ea = EA_AX_DI_16(); return m68ki_read_16(ea);}
INLINE uint32 OPER_AX_DI_32(void) {uint32 ea = EA_AX_DI_32(); return m68ki_read_32(ea);}
INLINE uint32 OPER_AX_IX_8(void)  {uint32 ea = EA_AX_IX_8();  return m68ki_read_8(ea); }
INLINE uint32 OPER_AX_IX_16(void) {uint32 ea = EA_AX_IX_16(); return m68ki_read_16(ea);}
INLINE uint32 OPER_AX_IX_32(void) {uint32 ea = EA_AX_IX_32(); return m68ki_read_32(ea);}

INLINE uint32 OPER_A7_PI_8(void)  {uint32 ea = EA_A7_PI_8();  return m68ki_read_8(ea); }
INLINE uint32 OPER_A7_PD_8(void)  {uint32 ea = EA_A7_PD_8();  return m68ki_read_8(ea); }

INLINE uint32 OPER_AW_8(void)     {uint32 ea = EA_AW_8();     return m68ki_read_8(ea); }
INLINE uint32 OPER_AW_16(void)    {uint32 ea = EA_AW_16();    return m68ki_read_16(ea);}
INLINE uint32 OPER_AW_32(void)    {uint32 ea = EA_AW_32();    return m68ki_read_32(ea);}
INLINE uint32 OPER_AL_8(void)     {uint32 ea = EA_AL_8();     return m68ki_read_8(ea); }
INLINE uint32 OPER_AL_16(void)    {uint32 ea = EA_AL_16();    return m68ki_read_16(ea);}
INLINE uint32 OPER_AL_32(void)    {uint32 ea = EA_AL_32();    return m68ki_read_32(ea);}
INLINE uint32 OPER_PCDI_8(void)   {uint32 ea = EA_PCDI_8();   return m68ki_read_pcrel_8(ea); }
INLINE uint32 OPER_PCDI_16(void)  {uint32 ea = EA_PCDI_16();  return m68ki_read_pcrel_16(ea);}
INLINE uint32 OPER_PCDI_32(void)  {uint32 ea = EA_PCDI_32();  return m68ki_read_pcrel_32(ea);}
INLINE uint32 OPER_PCIX_8(void)   {uint32 ea = EA_PCIX_8();   return m68ki_read_pcrel_8(ea); }
INLINE uint32 OPER_PCIX_16(void)  {uint32 ea = EA_PCIX_16();  return m68ki_read_pcrel_16(ea);}
INLINE uint32 OPER_PCIX_32(void)  {uint32 ea = EA_PCIX_32();  return m68ki_read_pcrel_32(ea);}
 ...
 */
INLINE void m68ki_set_s_flag(uint32 value)
{
...
INLINE void m68ki_set_ccr(uint32 value)
{
...
INLINE void m68ki_set_sr(uint32 value)
{
...
INLINE uint32 m68ki_init_exception(void)
{
  /* Save the old status register */
  uint32 sr = m68ki_get_sr();
...
INLINE void m68ki_stack_frame_3word(uint32 pc, uint32 sr)
{
  m68ki_push_32(pc);
  m68ki_push_16(sr);
}
