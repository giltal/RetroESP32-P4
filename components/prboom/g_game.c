...
void G_DoLoadGame(void)
{
  ...
  lprintf(LO_INFO, "G_DoLoadGame: skill=%d ep=%d map=%d\n", gameskill, gameepisode, gamemap);

  // load a base level
  G_InitNew (gameskill, gameepisode, gamemap);
  lprintf(LO_INFO, "G_DoLoadGame: G_InitNew done\n");
  ...
  P_MapStart();
  lprintf(LO_INFO, "G_DoLoadGame: P_UnArchivePlayers...\n");
  P_UnArchivePlayers ();
  lprintf(LO_INFO, "G_DoLoadGame: P_UnArchiveWorld...\n");
  P_UnArchiveWorld ();
  lprintf(LO_INFO, "G_DoLoadGame: P_UnArchiveThinkers...\n");
  P_UnArchiveThinkers ();
  lprintf(LO_INFO, "G_DoLoadGame: P_UnArchiveSpecials...\n");
  P_UnArchiveSpecials ();
  lprintf(LO_INFO, "G_DoLoadGame: P_UnArchiveRNG...\n");
  P_UnArchiveRNG ();    // killough 1/18/98: load RNG information
  lprintf(LO_INFO, "G_DoLoadGame: P_UnArchiveMap...\n");
