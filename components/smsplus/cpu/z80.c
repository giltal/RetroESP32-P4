...
/* Actual definitions of the variables declared extern in z80.h */
...
#define cpu_readmem16(a)        cpu_readmap[((a) & 0xFFFF) >> 10][(a) & 0x03FF]
#define cpu_readop(a)           cpu_readmap[((a) & 0xFFFF) >> 10][(a) & 0x03FF]
#define cpu_readop_arg(a)       cpu_readmap[((a) & 0xFFFF) >> 10][(a) & 0x03FF]
...
#else
static const UINT8 SZ[256] = {       /* zero and sign flags */
