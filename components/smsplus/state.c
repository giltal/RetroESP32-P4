...
void system_load_state(void *mem)
{
  ...
  /* Fix old save states created before LSB_FIRST was defined.
     On little-endian hardware with big-endian PAIR layout, the 16-bit register
     values ended up in the upper 16 bits of the 32-bit .d member.  Detect this
     by checking SP which should always be <= 0xFFFF after a proper save. */
  if (Z80.sp.d > 0xFFFF || Z80.pc.d > 0xFFFF) {
      Z80.pc.d  = (Z80.pc.d  >> 16) & 0xFFFF;
      Z80.sp.d  = (Z80.sp.d  >> 16) & 0xFFFF;
      Z80.af.d  = (Z80.af.d  >> 16) & 0xFFFF;
      Z80.bc.d  = (Z80.bc.d  >> 16) & 0xFFFF;
      Z80.de.d  = (Z80.de.d  >> 16) & 0xFFFF;
      Z80.hl.d  = (Z80.hl.d  >> 16) & 0xFFFF;
      Z80.ix.d  = (Z80.ix.d  >> 16) & 0xFFFF;
      Z80.iy.d  = (Z80.iy.d  >> 16) & 0xFFFF;
      Z80.wz.d  = (Z80.wz.d  >> 16) & 0xFFFF;
      Z80.af2.d = (Z80.af2.d >> 16) & 0xFFFF;
      Z80.bc2.d = (Z80.bc2.d >> 16) & 0xFFFF;
      Z80.de2.d = (Z80.de2.d >> 16) & 0xFFFF;
      Z80.hl2.d = (Z80.hl2.d >> 16) & 0xFFFF;
      printf("state: fixed old-endian Z80 save (PC=%04x SP=%04x)\n",
