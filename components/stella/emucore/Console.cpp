...
// ESP32-P4: sstream removed (ostringstream in stella_compat_streams.h via bspf.hxx)
#include "stella_compat_fstream.h"
...
{
  // CompuMate handler removed for ESP32-P4 minimal build
  (void)state;
}
