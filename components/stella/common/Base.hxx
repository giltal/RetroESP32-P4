...
// ESP32-P4: iostream removed (in stella_compat_streams.h via bspf.hxx)
// ESP32-P4: iomanip removed (manipulators in stella_compat_streams.h via bspf.hxx)
...
class Base
{
  ...
  public:
    ...
    static bool hexUppercase() { return myUppercase; }

    /** Output HEX digits in 1/2/4 byte format */
    static inline ostream& HEX2(ostream& os) {
      os.set_hex(true);
      return os;
    }
    static inline ostream& HEX4(ostream& os) {
      os.set_hex(true);
      return os;
    }
    static inline ostream& HEX8(ostream& os) {
      os.set_hex(true);
      return os;
    }
