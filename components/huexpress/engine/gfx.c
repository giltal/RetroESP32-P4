...
//! VDC Control Register captured at display start (not during VBLANK)
uint16 pce_display_cr;

//! One-shot callback invoked right after gfx_init() inside exe_go()
void (*pce_post_gfx_init_cb)(void) = NULL;

//! Resume CR protection: how many frames to override gfx context CR
volatile int pce_resume_cr_protect = 0;
uint16 pce_resume_cr_value = 0;
