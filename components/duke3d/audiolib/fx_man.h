...
int FX_PlayWAV( uint8_t *ptr, int32_t pitchoffset, int32_t vol, int32_t left, int32_t right,
...
int FX_PlayVOC3D( uint8_t *ptr, int32_t pitchoffset, int32_t angle, int32_t distance,
       int32_t priority, uint32_t callbackval );
int FX_PlayWAV3D( uint8_t *ptr, int32_t pitchoffset, int32_t angle, int32_t distance,
       int32_t priority, uint32_t callbackval );
