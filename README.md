🎮 RetroESP32-P4
Platform Status License Performance UI

🧠 Overview
RetroESP32-P4 is a high-performance retro gaming platform built on off the shelf ESP32-P4 platform (see picture), bringing together multiple classic systems into a single, compact device. The platform and the USB SNES controller available at AliExpress for around 35$ (both)

🚀 Getting Started

This platform is affordable, reliable, and performs great. Soon, I’ll be releasing a dedicated board that turns it into a fully standalone console.
...
Recommended tool: 👉 https://espressif.github.io/esptool-js/
